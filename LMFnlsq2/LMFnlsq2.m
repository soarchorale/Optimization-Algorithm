...
if nargin==0 || (nargin==1 && strcmpi('default',varargin(1)))
   ...
   xf.FunTol   = 1e-16;      %   tolerace for final function value
   xf.XTol     = 1e-16;      %   tolerance on difference of x-solutions
   ...
   xf.Basdx    = 1e-14;     %   basic step dx for gradient evaluation
   return
