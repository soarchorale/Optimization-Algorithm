function [Xbestout Xcurrent] = Evolution( initialtemperature ,coolingrate,...
    maxiterations,initialsolution,mintemperature)
%Evolution Summary of this function goes here
...
while p < step2
    ...
    [Xbest_temp,Xcurrent_k] = Sampling (Xbest,Xcurrent_i,T,step1);
